...
inline static const C *String_Find5(const C *pBegin, const C *pEnd, C v0, U32 v1) {
  do {
      if(*pBegin == v0 && *(U32*)(pBegin + 1) == v1)
        return pBegin;
    } while (++pBegin != pEnd);
  return 0;
}
...
inline static const C *String_FindLast5(const C *pRBegin, const C *pREnd, C v0, U32 v1) {
  do {
      if (*pRBegin == v0 && *(U32*)(pRBegin + 1) == v1)
        return pRBegin;
    } while (--pRBegin != pREnd);
  return 0;
}
...
inline static const C *String_FindLast7(const C *pRBegin, const C *pREnd, C v0, U16 v1, U32 v2) {
  do {
      if (*pRBegin == v0 && *(U16*)(pRBegin + 1) == v1 && *(U32*)(pRBegin + 3) == v2)
        return pRBegin;
    } while (--pRBegin != pREnd);
  return 0;
}
