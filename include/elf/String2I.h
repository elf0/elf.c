...
//Parse '+' youself.
static inline E8 String_ParseI32_Positive(const C **ppszNumber, I32 *piValue);
static inline E8 String_ParseI64_Positive(const C **ppszNumber, I64 *piValue);

//Parse '-*' youself
static inline E8 String_ParseI32_Negative(const C **ppszNumber, I32 *piValue);
static inline E8 String_ParseI64_Negative(const C **ppszNumber, I64 *piValue);


//Parse '0b', '+0b', '-0b*' prefix youself
static inline E8 String_ParseBinaryI32_Positive(const C **ppszNumber, I32 *piValue);
static inline E8 String_ParseBinaryI32_Negative(const C **ppszNumber, I32 *piValue);
static inline E8 String_ParseBinaryI64_Positive(const C **ppszNumber, I64 *piValue);
static inline E8 String_ParseBinaryI64_Negative(const C **ppszNumber, I64 *piValue);

//Parse '0o', '+0o', '-0o*' prefix youself
static inline E8 String_ParseOctalI32_Positive(const C **ppszNumber, I32 *piValue);
static inline E8 String_ParseOctalI32_Negative(const C **ppszNumber, I32 *piValue);
static inline E8 String_ParseOctalI64_Positive(const C **ppszNumber, I64 *piValue);
static inline E8 String_ParseOctalI64_Negative(const C **ppszNumber, I64 *piValue);

//Parse '0x', '+0x', '-0x' prefix youself
static inline E8 String_ParseHexI32_Positive(const C **ppszNumber, I32 *piValue);
static inline E8 String_ParseHexI32_Negative(const C **ppszNumber, I32 *piValue);
static inline E8 String_ParseHexI64_Positive(const C **ppszNumber, I64 *piValue);
static inline E8 String_ParseHexI64_Negative(const C **ppszNumber, I64 *piValue);
////////////////////////////////////////////////////////////////
static inline E8 String_ParseI32_Positive(const C **ppszNumber, I32 *piValue){
